...
export default function PairWithSuggestionsMale() {
  const location = useLocation();
  const topStyle = location.state?.topStyle || 'Black Shirt over White Tee';

  const maleSuggestionsData = {
    'Black Shirt over White Tee': {
      text: 'Style it with slim-fit black jeans and low-top white sneakers for a clean and confident monochrome look. You can also throw in a metal watch or a simple bracelet to enhance the smart casual feel.',
      image: 'https://www.fashionbeans.com/wp-content/uploads/2016/09/wayswhitetshirt-5.jpg',
    },
    'Basic Tee': {
